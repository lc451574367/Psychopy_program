...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='E:\\post_log\\voice_imagery\\exp\\Exp_preparation\\Voice imagery task\\Program_psychopy\\Voice_imagery_task\\Sub01\\Voice_imagery_task_lastrun.py',
